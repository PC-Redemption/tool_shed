# Program Roadmap: Validation Consolidation

Status: superseded
Type: program-roadmap
Updated: 2026-08-27
Next Action: none
Roadmap ID: validation-consolidation
Revision: 1
Source Project Map: work/maps/map-validation-consolidation.md
Source State Token: 3b01afcac081f26f
Proposal Token: 8fcb81ffe8d639e9
Approved: 2026-08-27
Current Milestone: M1-CONSOLIDATED-QUALIFICATION
Supersedes: none
Superseded By: work/roadmaps/roadmap-validation-consolidation-r2.md
...
```json
{
  ...
  "assumptions": [
    "Independent test modules can run concurrently without shared-state coupling.",
    "Heavy release-only integration scenarios remain covered in release qualification."
  ],
  "authority_boundaries": "Autonomy level 3 authorizes PRM materialization, implementation, validation, campaign transitions, and a local commit; it does not authorize remote mutation, push, release, deployment, or skill synchronization.",
  "candidate_campaigns": [
    {
      "campaign_id": "consolidate-validation-profiles-and-contracts",
      "completion_gate": "Focused profile passes; full is under 45 seconds; release is under 60 seconds; preserved scenarios and safety contracts pass; CLI and operator documentation describe profile ownership.",
      "decision": "none",
      "depends_on": [],
      ...
      "primary_focus_areas": [],
      "request": "Consolidate Tool Shed validation so each behavior and contract is checked once at the lowest useful layer, focused/full/release profiles avoid repeated work, and safety coverage and failure isolation are preserved. Target full validation under 45 seconds and release qualification under 60 seconds; use test count only as a secondary metric. Execute through work1 only\u2014local commit, no push or release.",
      "supporting_focus_areas": [],
      "title": "Consolidate validation profiles and contracts",
      "unlocks_gate": "G1-VALIDATION-EFFICIENT"
    }
  ],
  "constraints": "Execute through work1 only. Full validation must finish under 45 seconds and release qualification under 60 seconds on the qualification host. Test count is secondary.",
  "decisions": [
    "Use one milestone and one campaign.",
    "Measure wall-clock time and preserved scenario coverage before considering test count.",
    "Keep release qualification exhaustive while making full validation the comprehensive development profile."
  ],
  "desired_outcome": "Each Tool Shed behavior and contract is checked once at the lowest useful layer; focused, full, and release profiles avoid repeated work while preserving safety coverage and isolated failure reporting.",
  "gates": [
    {
      "evidence_required": true,
      "id": "G1-VALIDATION-EFFICIENT",
      "pass_criteria": "Focused checks pass; full validation is under 45 seconds; release qualification is under 60 seconds; all preserved behavioral scenarios and provider, manifest, roadmap/work-state, stale-path, and snapshot safety contracts remain covered at one intentional layer.",
      "requires_milestones": [
        "M1-CONSOLIDATED-QUALIFICATION"
      ],
      "title": "Validation is efficient and safe",
      "unlocks_milestones": []
    }
  ],
  "milestones": [
    {
      "depends_on": [],
      "id": "M1-CONSOLIDATED-QUALIFICATION",
      "outcome": "Focused, full, and release profiles have explicit ownership, preserved safety coverage, isolated failures, and meet their runtime budgets.",
      "phase": "P1-CONSOLIDATION",
      "title": "Consolidated qualification"
    }
  ],
  "non_goals": "Cosmetic test-count reduction; removal of distinct safety scenarios; push, release, deployment, or installed-skill synchronization.",
  "phases": [
    {
      "depends_on": [],
      "id": "P1-CONSOLIDATION",
  ...
  "unknowns": [
    "The final count of tests after eliminating wrapper-level duplicates."
  ]
}
```
