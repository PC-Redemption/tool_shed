# Program Roadmap: Persistent Autonomy Levels

Status: superseded
Type: program-roadmap
Updated: 2026-08-27
Next Action: none
Roadmap ID: persistent-autonomy-levels
Revision: 1
Source Project Map: work/maps/map-persistent-autonomy-levels.md
Source State Token: dc8802ac76fb7451
Proposal Token: d10be0f87590910d
Approved: 2026-08-27
Current Milestone: M1-AUTONOMY-CORE
Supersedes: none
Superseded By: work/roadmaps/roadmap-persistent-autonomy-levels-r2.md
...
```json
{
  "artifact_mappings": [
    ...
    },
    {
      ...
      "conflicts": [],
      "evidence": "Type campaign; Status blocked",
      "mapping_state": "unmapped",
      "milestone": null,
      "path": "work/00-campaigns/active/096-publish-and-synchronize-passive-app-server-dogfooding.md",
      "phase": null,
      "state_token": "409af34a22d87258"
    },
    {
      "classification": "remaining",
      "conflicts": [],
      "evidence": "Type campaign; Status queued",
      "mapping_state": "unmapped",
      "milestone": null,
      "path": "work/00-campaigns/active/097-field-dogfood-passive-app-server-mode.md",
      "phase": null,
      "state_token": "18d768318864d312"
    },
    {
  ...
  "assumptions": [
    "Most repeated prompts are agent confirmation pauses rather than provider-native permission dialogs.",
    "A project-bound user-local preference is safer than a silent user-wide default and still removes recurring setup within ongoing work.",
    "The existing App Server preference store provides reusable atomic-state and sanitization patterns without coupling autonomy to App Server selection.",
    "One core milestone can settle and implement the complete level contract without adding a general policy engine."
  ],
  "authority_boundaries": "Project-map approval does not approve this roadmap. Roadmap approval does not materialize campaigns. Campaign-plan approval does not authorize execution. Release, publication, client synchronization, protected environments, credentials, unknown targets, cross-workspace work, purchases, legal commitments, and broad destructive or irreversible operations retain their ordinary explicit authority and provider controls.",
  "candidate_campaigns": [
    {
      "campaign_id": "define-and-implement-persistent-autonomy-levels",
      "completion_gate": "Focused autonomy suites, provider conformance, full repository validation, and generated documentation checks pass.",
      "decision": "none",
      "depends_on": [],
      "milestone": "M1-AUTONOMY-CORE",
      "outcome": "Tool Shed implements the complete project-bound 0-to-5 autonomy contract with deterministic categories, protected persistence, route integration, status and overrides, tests, and documentation.",
      "primary_focus_areas": [
        "provider-portability"
      ],
      "request": "Settle the exact machine-testable action matrix from the approved roadmap, implement the smallest protected preference and route integration, preserve always-ask and provider boundaries, update operator documentation, and verify the complete local candidate.",
      "supporting_focus_areas": [
        "campaign-lifecycle",
        "artifact-workflows"
      ],
      "title": "Define and implement persistent autonomy levels",
      "unlocks_gate": "G1-CORE-QUALIFIED"
    },
    {
      "campaign_id": "publish-and-synchronize-persistent-autonomy-levels",
      "completion_gate": "Release provenance, remote CI, installed-skill byte parity, and fresh-session status checks pass.",
      "decision": "release and publication require separate work5 authority",
      "depends_on": [
        "define-and-implement-persistent-autonomy-levels"
      ],
      "milestone": "M2-RELEASE-ADOPTION",
      "outcome": "A traceable release and synchronized maintainer/client skill make the qualified autonomy behavior available for normal work.",
      "primary_focus_areas": [
        "qualification-release"
      ],
      "request": "Qualify the approved core for release, publish through the existing release procedure, synchronize the installed Codex skill, and verify fresh-session command status under separate work5 and external-publication authority.",
      "supporting_focus_areas": [
        "snapshot-delivery",
        "provider-portability"
      ],
      "title": "Publish and synchronize persistent autonomy levels",
      "unlocks_gate": "none"
    },
    {
      "campaign_id": "field-verify-persistent-autonomy-levels",
      "completion_gate": "Sanitized field evidence records at least one covered continuation and one correctly preserved authority boundary without scope drift.",
      "decision": "product-work mutations retain separate workspace authority",
      "depends_on": [
        "publish-and-synchronize-persistent-autonomy-levels"
      ],
      "milestone": "M2-RELEASE-ADOPTION",
      "outcome": "Representative normal work demonstrates fewer redundant confirmations and correct stops at every always-ask boundary.",
      "primary_focus_areas": [
        "provider-portability"
      ],
      "request": "Use the released project-bound preference in representative Tool Shed work, capture sanitized evidence, and report any category or precedence drift without silently revising approved intent.",
      "supporting_focus_areas": [
        "qualification-release",
        "workspace-safety"
      ],
      "title": "Field-verify persistent autonomy levels",
      "unlocks_gate": "G2-FIELD-PROVEN"
    }
  ],
  "constraints": "Reuse project identity, work1-work5 endpoint resolution, protected user-local atomic state, campaign continuity, and provider adapters. Fail safely on malformed, stale, foreign, or root-mismatched state. Keep action categories cumulative, deterministic, explainable, cross-platform, and separately qualified before release.",
  "decisions": [
    "Treat levels as confirmation and autonomy profiles, not as permission to invent work or expand scope.",
    "Use canonical ts: autonomy commands and retain ts: approve <level> as a numeric compatibility alias distinct from exact roadmap and campaign-plan approvals.",
    "Persist every level per verified project until reset; provide status, reset, and one-command tightening or elevation without changing the durable preference.",
    "Use cumulative levels: 0 Observe, 1 Edit, 2 Build, 3 Checkpoint, 4 Collaborate, and 5 Deliver.",
    "Bind go or continue to the current explicit outcome and endpoint; do not create a second durable authority source beyond the project preference and campaign state.",
    "Classify unknown or ambiguous actions as requiring confirmation and retain the project-map always-ask set at every level."
  ],
  "desired_outcome": "A persistent project-bound autonomy preference lets the owner choose levels 0 through 5 once, then Tool Shed continues covered in-scope work without repetitive confirmation while preserving exact semantic and provider safety boundaries.",
  "gates": [
    {
      "evidence_required": true,
      "id": "G1-CORE-QUALIFIED",
      "pass_criteria": "Focused category, precedence, persistence, stale-state, route-continuity, exact-approval, provider-conformance, and full repository validation pass with current documentation.",
      "requires_milestones": [
        "M1-AUTONOMY-CORE"
      ],
      "title": "Autonomy core is safe and deterministic",
      "unlocks_milestones": [
        "M2-RELEASE-ADOPTION"
      ]
    },
    {
      "evidence_required": true,
      "id": "G2-FIELD-PROVEN",
      "pass_criteria": "Release provenance, installed-skill parity, status evidence, and at least one representative workflow show reduced confirmation without scope or safety-boundary drift.",
      "requires_milestones": [
        "M2-RELEASE-ADOPTION"
      ],
      "title": "Released autonomy behavior works in normal use",
      "unlocks_milestones": []
    }
  ],
  "milestones": [
    {
      "depends_on": [],
      "id": "M1-AUTONOMY-CORE",
      "outcome": "The complete 0-to-5 project-bound autonomy contract, persistence, routing behavior, status, overrides, tests, and operator documentation pass focused and full local validation without weakening exact or provider-native approvals.",
      "phase": "P1-CORE",
      "title": "Implement and qualify persistent autonomy core"
    },
    {
      "depends_on": [
        "M1-AUTONOMY-CORE"
      ],
      "id": "M2-RELEASE-ADOPTION",
      "outcome": "A traceable release and synchronized installed skill expose the qualified feature, and representative work confirms that covered actions continue without repetitive prompts while always-ask boundaries still stop correctly.",
      "phase": "P2-ADOPTION",
      "title": "Publish, synchronize, and field-verify autonomy levels"
    }
  ],
  "non_goals": "No blanket authority outside an explicit task; no provider permission bypass; no automatic semantic approval; no global default, server, database, dashboard, background worker, purchase authority, credential management, or unbounded destructive action in the initial program.",
  "phases": [
    {
      "depends_on": [],
      "id": "P1-CORE",
      "title": "Autonomy contract and core"
    },
    {
      "depends_on": [
        "P1-CORE"
      ...
      "id": "P2-ADOPTION",
      "title": "Release and field adoption"
    }
  ],
  "unknowns": [
    "Field use may show that a small number of action categories need finer classification.",
    "A later explicit global default may be useful after project-bound behavior is proven.",
    "Observed use will determine whether optional expiration or campaign-scoped elevation deserves a later revision."
  ]
}
```
...
- Revision 1: superseded on 2026-08-27.
