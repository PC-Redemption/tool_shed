...
```json
{
  ...
  "assumptions": [
    "Python 3.11+ standard-library sqlite3 is sufficient for the phase-one embedded store.",
    "The current file/Git implementation remains the write authority during shadow import and dual-read qualification.",
    "The HPT2 historical cycle contains enough preserved source and product evidence to qualify the minimum closed-loop vocabulary without inventing missing history.",
    "A local Git repository is the supported production baseline; GitHub hosting and authenticated gh remain optional.",
    "The current project-identity, updater, validator, roadmap, campaign, evidence, and release mechanisms are reused and extended rather than replaced wholesale."
  ],
  "authority_boundaries": "This promotion authorizes faithful project-map, roadmap, and milestone campaign planning only. It does not authorize source implementation, database cutover, destructive retirement, commits, pushes, publication, release, installed-skill synchronization, downstream workspace mutation, production deployment, credentials, cross-workspace action, or resolution of the separately unfinished persistent-autonomy release priority. Later execution must remain inside its explicit requested endpoint and obtain new authority for protected or external actions.",
  "candidate_campaigns": [
    {
      "campaign_id": "establish-hybrid-bootstrap-closure-and-design-contract",
      "completion_gate": "The bootstrap tool and tracked baseline fail on missing or stale requirements, material changes, evidence, upgrade targets, or verdicts; the exact entity/field authority, checkpoint/event, schema/trigger, per-worktree, merge/rebuild, migration, updater, backup, rollback, downgrade, HPT2 inventory, and token-fixture decisions are documented and G1 evidence is complete.",
      "decision": "none",
      "depends_on": [],
      "milestone": "M1-BOOTSTRAP-DESIGN-FROZEN",
      "outcome": "A tracked independent closure baseline, change ledger, verifier, and exact phase-one authority/design contract make the hybrid initiative auditable before database-backed reconciliation exists.",
      "primary_focus_areas": [
        "artifact-workflows"
      ],
      "request": "Create the smallest file/Git bootstrap closure manifest and deterministic baseline, record-change, verify, and report surface needed to govern this initiative. Freeze the phase-one SQLite and portability contracts without implementing database authority. Reuse existing identity, token, validation, evidence, updater, and release mechanisms. Preserve unknowns and require exact dispositions. Requested endpoint: work3 local candidate only; do not begin SQLite cutover, push, publish, synchronize skills, or mutate clients.",
      "supporting_focus_areas": [
        "workspace-safety",
        "snapshot-delivery",
        "qualification-release"
      ],
      "title": "Establish hybrid bootstrap closure and design contract",
      "unlocks_gate": "G1-DESIGN-FROZEN"
    },
    {
      "campaign_id": "implement-minimum-sqlite-operational-substrate",
      "completion_gate": "Focused and full tests prove schema creation and migration, foreign keys, revision/trigger accounting, managed and unmanaged writes, project/worktree lineage, deterministic checkpoint/export, fresh rebuild, corruption detection, backup, interruption recovery, and legacy writer refusal while campaigns, roadmaps, general bodies, and legacy retirement remain file-owned.",
      "decision": "none",
      "depends_on": [
        "establish-hybrid-bootstrap-closure-and-design-contract"
      ],
      "milestone": "M2-SUBSTRATE-HPT2-PROVEN",
      "outcome": "Tool Shed has immutable public IDs, import provenance, typed relationships, revisions/events, evidence references, migration/export/checkpoint ledgers, guarded transactions, DB-enforced dirty accounting, entrance audits, and deterministic portable rebuild without moving excluded domains.",
      "primary_focus_areas": [
        "artifact-workflows"
      ],
      "request": "Implement only the approved phase-one embedded SQLite substrate and shared managed access layer. Keep the live DB ignored and per-worktree, use standard-library sqlite3, preserve source files, and provide shadow import plus deterministic rebuild. Add focused cross-platform tests and docs. Requested endpoint: work3 local candidate; no live maintainer conversion, release, skill sync, or client upgrade.",
      "supporting_focus_areas": [
        "workspace-safety",
        "snapshot-delivery",
        "qualification-release"
      ],
      "title": "Implement the minimum SQLite operational substrate",
      "unlocks_gate": "none"
    },
    {
    ...
    },
    {
      ...
      "request": "After G3 passes and only under separate explicit release authority, freeze the unchanged candidate, qualify and publish through the documented two-commit process, then synchronize the installed maintainer skill through its special host-local procedure. Requested endpoint: work5 release; stop before any downstream client upgrade.",
      "supporting_focus_areas": [
        "snapshot-delivery",
        "provider-portability"
      ],
      "title": "Publish the hybrid-state release and synchronize the maintainer skill",
      "unlocks_gate": "none"
    },
    {
      "campaign_id": "qualify-disconnected-hybrid-production-canary",
      "completion_gate": "The released external updater backs up and migrates the declared file/database/skill surface, validates reconstruction and closed-loop state, handles old-updater refusal, operates without gh authentication or a project remote, restores from external backup, downgrades through verified reverse export or refuses safely, and completes the required soak with no unresolved finding; G4 passes.",
      "decision": "Separate owner authorization and an exact known client target are required before external workspace mutation.",
      "depends_on": [
        "publish-hybrid-state-release-and-sync-maintainer-skill"
      ],
      "milestone": "M4-RELEASE-CANARY-PROVEN",
      ...
      "request": "After the release and only under separate explicit client-mutation authority, upgrade one disposable or low-risk disconnected client through the normal released updater. Verify no-GitHub project operation, DB/checkpoint lineage, closure, context efficiency, backup/restore, rollback, and downgrade behavior. Record compact durable evidence and stop before broad fleet rollout.",
      "supporting_focus_areas": [
        "qualification-release",
        "workspace-safety",
        "artifact-workflows"
      ],
      "title": "Qualify a disconnected hybrid production canary",
      "unlocks_gate": "G4-RELEASE-CANARY-PROVEN"
    }
  ],
  "constraints": "Use Python standard-library SQLite and local Git; keep imports and canonical product truth file-owned; give every worktree a separate ignored database; use deterministic tracked checkpoints as the collaboration/rebuild surface; preserve project identity, stale-write fencing, authority boundaries, provider portability, no-data-loss conversion, database-level revision accounting, managed entrance audits, and explicit direct-SQL reconciliation; keep all original files through the first release and soak; require the independent bootstrap closure harness before the new database loop can certify itself.",
  "decisions": [
    "Use a hybrid SQLite/file authority boundary rather than file-only or database-only storage.",
    "Implement only the minimum SQLite substrate before the closed-loop vertical slice; do not migrate all Tool Shed state first.",
    "Use an independent tracked bootstrap closure manifest and validator for this initiative, then require database import and verdict parity before database reconciliation becomes authoritative.",
    "Give every worktree its own ignored live database and use deterministic tracked logical checkpoints/events for review, collaboration, and rebuild.",
    "Keep domain scripts or a shared state library as the supported write surface while database triggers and entrance audits detect, classify, and never silently bless bypass SQL.",
    "Preserve all original files through conversion and the first release; legacy retirement is a later separately authorized migration.",
  ...
  "gates": [
    {
      ...
      "id": "G1-DESIGN-FROZEN",
      "pass_criteria": "The bootstrap closure baseline and verifier are operational; every phase-one entity and field has one authority; checkpoint/event, per-worktree, merge/rebuild, database location, schema/trigger, migration, updater, backup, rollback, and downgrade contracts are explicit; the exact source state and HPT2 evidence inventory are recorded; and no unresolved decision can change schema version 1 or the no-data-loss promise.",
      "requires_milestones": [
        "M1-BOOTSTRAP-DESIGN-FROZEN"
      ],
      "unlocks_milestones": [
        "M2-SUBSTRATE-HPT2-PROVEN"
      ]
    },
    {
      "evidence_required": true,
      "id": "G2-SUBSTRATE-LOOP-PROVEN",
      "pass_criteria": "The minimum SQLite store passes integrity, foreign-key, revision-ledger, entrance-audit, direct-SQL, deterministic export/rebuild, byte/semantic parity, interrupted-write/migration, and HPT2 bootstrap-verdict reproduction tests; representative state-heavy operations achieve at least 70% median context reduction with semantic/evidence parity and no more than 5% explained full-scan fallback.",
      "requires_milestones": [
        "M2-SUBSTRATE-HPT2-PROVEN"
      ],
      "unlocks_milestones": [
        "M3-MAINTAINER-HYBRID-PROVEN"
      ]
    },
    {
      "evidence_required": true,
      "id": "G3-MAINTAINER-CONVERSION-PROVEN",
      "pass_criteria": "The exact maintainer conversion is deterministic in a disposable clone and succeeds live under a lock and no-write validation window; external archive, SQLite backup, reverse export, rollback, branch/worktree handling, bootstrap closure, full validation, and soak evidence pass with all original files preserved.",
      "requires_milestones": [
        "M3-MAINTAINER-HYBRID-PROVEN"
      ],
      "unlocks_milestones": [
        "M4-RELEASE-CANARY-PROVEN"
      ]
    },
    {
      "evidence_required": true,
      "id": "G4-RELEASE-CANARY-PROVEN",
      "pass_criteria": "The exact content commit passes Windows and POSIX release qualification; the published release and provenance are verified; the maintainer installed skill exactly matches after separate synchronization; one disconnected client with no gh authentication or project remote upgrades, rebuilds, reconciles, backs up, restores, and when applicable downgrades or refuses safely; and no unresolved closed-loop or soak finding remains.",
      "requires_milestones": [
        "M4-RELEASE-CANARY-PROVEN"
      ],
      "unlocks_milestones": []
  ...
  "milestones": [
    {
      "depends_on": [],
      "id": "M1-BOOTSTRAP-DESIGN-FROZEN",
      "outcome": "An independent bootstrap closure baseline and validator protect the initiative, and the phase-one authority, schema, checkpoint, migration, updater, merge, backup, and downgrade contracts are frozen with all material unknowns explicitly disposed or routed to evidence.",
      "phase": "P1-BOOTSTRAP-DESIGN"
    },
    {
      "depends_on": [
    ...
    },
    {
      ...
      "id": "M3-MAINTAINER-HYBRID-PROVEN",
      "outcome": "A disposable rehearsal and the first authoritative live maintainer conversion pass shadow import, parity, integrity, interruption, branch/worktree, backup, reverse-export, rollback, direct-SQL, closure, and soak gates while retaining every original file.",
    ...
    },
    {
      ...
      "id": "M4-RELEASE-CANARY-PROVEN",
      "outcome": "A verified database-aware release, separate installed-skill synchronization, and one production-shaped disconnected client canary prove upgrade, old-updater refusal, downgrade behavior, recovery, no-GitHub operation, and post-upgrade closed-loop reconciliation before broad rollout.",
      "phase": "P4-RELEASE-CANARY"
    }
  ],
  "non_goals": "Phase one does not move full campaign, roadmap, or milestone authority into SQLite; store general Markdown bodies; retire legacy files; require GitHub, gh, MCP, App Server, a database server, or cloud services; broadly normalize ambiguous history; or authorize publication, installed-skill synchronization, client mutation, or production rollout merely from planning promotion.",
  "phases": [
    {
      "depends_on": [],
      "id": "P1-BOOTSTRAP-DESIGN",
      "title": "Bootstrap closure and design freeze"
    },
    {
      "depends_on": [
        "P1-BOOTSTRAP-DESIGN"
      ],
      "id": "P2-SUBSTRATE-LOOP",
      "title": "Minimum substrate and HPT2 closed loop"
    },
    {
      "depends_on": [
        "P2-SUBSTRATE-LOOP"
      ],
      "id": "P3-MAINTAINER-CONVERSION",
      "title": "Recovery qualification and maintainer conversion"
    },
    {
      "depends_on": [
        "P3-MAINTAINER-CONVERSION"
      ],
      "id": "P4-RELEASE-CANARY",
      "title": "Release and disconnected client canary"
    }
  ],
  "unknowns": [
