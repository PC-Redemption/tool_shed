...
```json
{
  "artifact_mappings": [
    ...
    },
    {
      ...
      "evidence": "Owner-originated umbrella intake was deferred on 2026-08-18 so staged roadmap-derived campaigns can replace single-campaign execution after separate approval.",
    ...
    {
      "classification": "completed",
      "evidence": "Accepted ADR fixes the local-authority, durable-outbox, optional hosted status, and centralized hosted email responsibility boundary.",
      "milestone": "M4-HOSTED-PILOT",
      "path": "work/adr/adr-centralize-watcher-email-delivery-at-ts-rookaro-com.md",
      "phase": "P3-HOSTED-PILOT",
      "state_token": "427dbb881bc378a6"
    },
    {
      "classification": "completed",
    ...
    },
    {
      ...
      "evidence": "Legacy headerless provider-portability evidence is not accepted as watcher-program evidence; new milestone evidence must be explicit and current.",
      "milestone": null,
    ...
    },
    {
      ...
      "evidence": "Dedicated active project map defines the watcher program workstreams, dependencies, gates, authority boundaries, and current review point.",
      "milestone": "M1-CONTRACT",
      "path": "work/maps/map-disposable-completion-watchers-and-hosted-notifications.md",
      "phase": "P1-LOCAL-FOUNDATION",
      "state_token": "25a6c4c07bfe0fac"
    },
    {
      "classification": "excluded",
      "evidence": "General Tool Shed evolution coordination remains standalone; the dedicated watcher project map owns this program.",
      "milestone": null,
      "path": "work/maps/map-tool-shed-evolution.md",
      "phase": null,
      "state_token": "ee6e576938e602e6"
    },
    {
      "classification": "completed",
  ...
  "assumptions": [
    "The canonical Tool Shed repository remains the source for portable watcher code and released snapshot distribution.",
    "Python remains available in supported Tool Shed installations and can host the portable protocol and spool logic.",
    "An existing project heartbeat may optionally invoke ensure-runner; installations without one document degraded reboot recovery.",
    "The static documentation deployment and an optional stateful backend can remain independently deployable behind public routing.",
    "Hosted notification recipients and mail-provider credentials can be configured centrally without exposing them to watcher scripts."
  ],
  "authority_boundaries": "Roadmap approval authorizes only the recorded strategy. Campaign-plan approval separately authorizes campaign creation, not execution. Neither approval authorizes implementation, release publication, snapshot or installed-client updates, deployment to ts.rookaro.com, credential creation, email-provider changes, production promotion, fleet mutation, destructive cleanup, or remote control.",
  "candidate_campaigns": [
    {
      "campaign_id": "define-completion-watcher-protocol-and-failure-model",
      "completion_gate": "A versioned contract and executable test oracle cover immutable targets; WAITING, SATISFIED, TERMINAL_UNSATISFIED, and CHECK_ERROR; missing-target grace; bounded checker errors; locking and lease recovery; cancellation; permissions; durable outbox and idempotency; reboot limitations; and downgrade behavior, with focused validation passing and evidence recorded.",
      "depends_on": [],
      "milestone": "M1-CONTRACT",
      "outcome": "Resolve the local watcher contract and implementation-blocking lifecycle, persistence, security, portability, and recovery semantics for GitHub issue #42.",
      "primary_focus_areas": [
        "provider-portability"
      ],
      "request": "Create the bounded technical spike and resulting current-truth documentation needed to freeze the watcher descriptor, checker result schema, state transitions, reason codes, filesystem layout, process/lock model, error policy, outbox semantics, security boundary, and Linux/Windows test oracle. Do not implement production runner behavior beyond fixtures needed to validate the contract.",
      "supporting_focus_areas": [
        "workspace-safety",
        "qualification-release"
      ],
      "title": "Define the completion-watcher protocol and failure model",
      "unlocks_gate": "G1-CONTRACT-ACCEPTED"
    },
    {
      "campaign_id": "implement-portable-local-completion-watcher-alpha",
      "completion_gate": "The local alpha passes deterministic tests for atomic arming, singleton/concurrent operation, 60-second default cadence, immutable-target evaluation, every terminal and checker-error path, cancellation, lease recovery, dispatcher crash, outbox replay, idle exit, optional ensure-runner recovery, safe permissions, and local-only operation.",
      "depends_on": [
        "define-completion-watcher-protocol-and-failure-model"
      ],
      ...
      "request": "Implement the approved protocol as a provider-neutral local Tool Shed capability with status, cancel, and ensure-runner commands. Keep hosted reporting behind the adapter boundary and disabled. Document machine-local state, security, limitations, and recovery behavior.",
      "supporting_focus_areas": [
        "workspace-safety",
        "qualification-release"
      ],
      "title": "Implement the portable local completion-watcher alpha",
      "unlocks_gate": "G2-LOCAL-ALPHA-PROVEN"
    },
    {
      "campaign_id": "qualify-and-release-local-completion-watchers",
      "completion_gate": "Native Linux and Windows process-lifecycle and failure-injection matrices pass; full Tool Shed validation passes; documentation, release manifest/provenance, normal installation and update distribution, rollback/downgrade safety, installed-client synchronization where authorized, and bounded pilot evidence are verified.",
      "depends_on": [
        "implement-portable-local-completion-watcher-alpha"
      ],
      "milestone": "M3-LOCAL-RELEASE",
      "outcome": "Prove the local watcher on native Linux and Windows, publish it through verified Tool Shed release provenance, and complete a bounded opt-in local pilot.",
      "primary_focus_areas": [
        "qualification-release"
      ],
      "request": "Harden the local alpha from evidence, qualify cross-platform behavior, document guarantees and degraded modes, prepare and publish the canonical release only under an explicit release route, and pilot the released local-only watcher before opening the hosted milestone.",
      "supporting_focus_areas": [
        "provider-portability",
        "snapshot-delivery",
        "workspace-safety"
      ],
      "title": "Qualify and release local completion watchers",
      "unlocks_gate": "G3-LOCAL-RELEASE-PROVEN"
    },
    {
      ...
      "title": "Build the hosted watcher status and email pilot",
      "unlocks_gate": "G4-HOSTED-PILOT-PROVEN"
    },
    {
      "campaign_id": "qualify-and-roll-out-hosted-watcher-notifications",
      "completion_gate": "Production deployment and rollback, monitoring, alerting, tenant isolation, credential issuance/rotation/revocation, backup/restore, retention/deletion, email audit and retry semantics, privacy/security review, capacity/rate limits, stale-reporter behavior, and bounded opt-in rollout evidence pass with no authority leakage into local task control.",
      "depends_on": [
        "build-hosted-watcher-status-and-email-pilot"
      ],
      "milestone": "M5-PRODUCTION-ROLLOUT",
      "outcome": "Production-qualify and deliberately expand the optional hosted watcher status and centralized notification service.",
      "primary_focus_areas": [
        "qualification-release"
      ],
      "request": "Harden the pilot from evidence, complete operational controls and documentation, deploy only under an explicit authorized production route, verify every layer, and expand enrollment gradually with measurable rollback thresholds. Preserve local-only and project-native adapter options.",
      "supporting_focus_areas": [
        "provider-portability",
        "workspace-safety"
      ],
      "title": "Qualify and roll out hosted watcher notifications",
  ...
  "gates": [
    {
      ...
      "id": "G1-CONTRACT-ACCEPTED",
      "pass_criteria": "The protocol and failure-model deliverable resolves checker states, immutable identity, missing-target grace, error exhaustion, locking/leasing, permissions, outbox/idempotency, cancellation, reboot limitations, and downgrade behavior; focused contract tests or executable fixtures pass.",
      "requires_milestones": [
        "M1-CONTRACT"
      ],
      "unlocks_milestones": [
    ...
    {
      "evidence_required": true,
      "id": "G2-LOCAL-ALPHA-PROVEN",
      "pass_criteria": "Local alpha evidence covers completion, legitimate long wait, unsuccessful terminal states, transient missing/check errors, persistent checker failure, duplicate starts, concurrent watches, dispatcher crash, stale lease recovery, cancellation, empty-runner exit, and outbox replay.",
      "requires_milestones": [
        "M2-LOCAL-ALPHA"
      ],
      "unlocks_milestones": [
    ...
    {
      "evidence_required": true,
      "id": "G3-LOCAL-RELEASE-PROVEN",
      "pass_criteria": "Native Linux and Windows qualification, full repository validation, release provenance, install/update distribution, rollback/downgrade checks, operator documentation, and bounded local pilot evidence pass without hosted dependency.",
      "requires_milestones": [
        "M3-LOCAL-RELEASE"
      ],
      "unlocks_milestones": [
    ...
    {
      "evidence_required": true,
      "id": "G5-PRODUCTION-QUALIFIED",
      "pass_criteria": "Production deployment and rollback are verified; monitoring, backup/restore, security/privacy review, credential operations, retention/deletion, notification audit, and bounded opt-in rollout evidence meet the accepted operational thresholds.",
      "requires_milestones": [
        "M5-PRODUCTION-ROLLOUT"
      ],
      "unlocks_milestones": []
  ...
  "milestones": [
    {
      "depends_on": [],
      "id": "M1-CONTRACT",
      "outcome": "A versioned watcher protocol, state machine, failure model, local state/permission boundary, notification contract, and test oracle are accepted with no unresolved implementation-blocking semantics.",
      "phase": "P1-LOCAL-FOUNDATION"
    },
    {
      "depends_on": [
      ...
      "id": "M2-LOCAL-ALPHA",
      "outcome": "A local opt-in alpha arms immutable watches, shares one on-demand runner, polls at 60 seconds, persists terminal events to an idempotent outbox, recovers leases, and exposes status/cancel/ensure-runner behavior under deterministic failure injection.",
      "phase": "P1-LOCAL-FOUNDATION"
    },
    {
      "depends_on": [
      ...
      "id": "M3-LOCAL-RELEASE",
      "outcome": "The local watcher is qualified on Linux and Windows, documented with degraded reboot semantics and rollback, published through the verified Tool Shed release path, and piloted without requiring hosted infrastructure.",
      "phase": "P2-LOCAL-RELEASE"
    },
    {
      "depends_on": [
        "M3-LOCAL-RELEASE"
    ...
    },
    {
      ...
      "id": "M5-PRODUCTION-ROLLOUT",
      "outcome": "Hosted watcher status and notification are production-qualified with tenancy, privacy, security, retention, backup/restore, revocation, monitoring, rollback, and bounded opt-in rollout evidence.",
      "phase": "P4-PRODUCTION-ROLLOUT"
    }
  ],
  "non_goals": "No sub-minute or safety-critical alerting; no hosted remote execution, cancellation, restart, approval, or task control; no requirement for a hosted account to use local watchers; no upload of watcher source, arbitrary command output, credentials, private evidence, or sensitive paths; no fleet rollout, production deployment, release, credential provisioning, or client synchronization from roadmap approval alone.",
  "phases": [
    {
      "depends_on": [],
      "id": "P1-LOCAL-FOUNDATION",
      "title": "Local contract and watcher foundation"
    },
    {
      "depends_on": [
        "P1-LOCAL-FOUNDATION"
      ...
      "id": "P2-LOCAL-RELEASE",
      "title": "Cross-platform qualification and local release"
    },
    {
      "depends_on": [
        "P2-LOCAL-RELEASE"
      ...
      "id": "P3-HOSTED-PILOT",
      "title": "Hosted status and email pilot"
    },
    {
      "depends_on": [
        "P3-HOSTED-PILOT"
      ],
      "id": "P4-PRODUCTION-ROLLOUT",
      "title": "Hosted production qualification and rollout"
    }
  ],
  "unknowns": [
    "Exact versioned watcher descriptor, checker interface, reason-code taxonomy, and malformed-output behavior.",
    "Cross-platform state-directory, file-permission, locking, leasing, detached-process, cancellation, and downgrade semantics.",
    "Pilot workload, workspace count, soak duration, and quantitative promotion thresholds.",
    "Hosted service runtime, durable store, authenticated UI model, tenant isolation, key rotation, retention, backup, rate limiting, and mail provider.",
    "Whether the hosted backend shares ts.rookaro.com path routing or uses a separately isolated service hostname while retaining the product URL."
  ]
}
```
