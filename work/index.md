...
| --- | --- | --- | --- | --- | --- |
| [work/00-campaigns/active/complete-portable-verified-installer.md](work/00-campaigns/active/complete-portable-verified-installer.md) | campaign | working | 2026-08-14 | execute the campaign completion gate | - |
...
| [work/maps/map-tool-shed-evolution.md](work/maps/map-tool-shed-evolution.md) | project-map | active | 2026-08-14 | run the native Windows launcher fallback test through GitHub Actions after an authorized push | - |
...
| [work/tickets/ticket-portable-verified-tool-shed-installer.md](work/tickets/ticket-portable-verified-tool-shed-installer.md) | ticket | active | 2026-08-14 | run the native Windows launcher fallback test through GitHub Actions after an authorized push | work/maps/map-tool-shed-evolution.md |
...
- Total artifacts: 48
- Active artifacts: 7
- Completed/decided artifacts: 39
