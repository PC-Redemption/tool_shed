...
| Portable verified installer | active | `work/tickets/ticket-portable-verified-tool-shed-installer.md` | Linux fallback test and full validator passed; native Windows result pending | authorize a push and run the Windows GitHub Actions matrix |
...
- [ ] Pass launcher runtime fallback against disposable Windows and Linux workspaces; Linux passes, Windows CI is pending an authorized push.
