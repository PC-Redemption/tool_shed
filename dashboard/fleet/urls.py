...
urlpatterns = [
    ...
    path("api/v1/qualification/reports", views.qualification_report_ingest, name="qualification-report-ingest"),
    ...
    path("dashboard/qualification-runs/", views.qualification_runs_view, name="qualification-runs"),
