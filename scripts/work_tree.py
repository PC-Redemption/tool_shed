...
- Use `python3 tool_shed/scripts/reconcile_campaign_queue.py --workspace . --json` to inspect queue drift, stalled campaigns, and proposed execution order without writing.
