...
class ReleasePublicationTests(unittest.TestCase):
    ...
    def test_release_workflow_and_runbook_close_the_tag_only_gap(self) -> None:
        ...
        self.assertIn("timeout-minutes: 20", validate_workflow)
        self.assertIn("--profile ${{ matrix.profile }}", validate_workflow)
        self.assertIn("--warn-seconds 60 --max-seconds 900", validate_workflow)
        ...
        self.assertIn("max-median-seconds: 300", performance_workflow)
        self.assertIn("--max-median-seconds ${{ matrix.max-median-seconds }}", performance_workflow)
